...
<%
    ...
    //pageContext.forward("/forward_demo.jsp");
    //使用pageContext.forward(relativeUrlPath)替代RequestDispatcher.forward(relativeUrlPath)
    //使用RequestDispatcher的forward方法实现的跳转方式
    //pageContext.getRequest().getRequestDispatcher("/forward_demo.jsp").forward(request, response);
%>
<jsp:forward page="/forward_demo.jsp"></jsp:forward>